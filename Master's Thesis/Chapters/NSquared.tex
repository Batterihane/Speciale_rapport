...
\section{Discussion?}
\todo{forrester, parsing, newick and so on. Guide on how to run it, recursive vs iterative, memory constrains, realistic tree sizes, problems with the algorithm overall}
...
\fbox{%
	\begin{minipage}{5.1 in}
		\textbf{How to Run}
		
		\begin{itemize}
			\item *link to github dl*
			\item *open cmd from this folder*
			\item *Type ... with argument X and Y for this algorithm *
			\item *
		\end{itemize}
	\end{minipage}}
